...
export class Game {
    ...
    async getGameBySlug ( slug ) {
      try {
        ...
        const populateGame = "populate[0]=wallpaper&populate[1]=cover&populate[2]=gallery&populate[3]=platform";
    ...
    async getGameById(idGame){
      try {
        const filters = `filters[id]=${idGame}`;
